...
if(isset($_GET['search'])){
    ...
    $query ="SELECT * FROM orderstable WHERE (UserName LIKE '%{$search}%'  OR RefNo LIKE '%{$search}%') AND is_deleted=0 AND Confirmation=1 ORDER BY RefNo";
}else{
    $query ="SELECT * FROM orderstable WHERE (is_deleted=0 AND Confirmation=1) ORDER BY RefNo";
}
    ...
    <form action="orders-view.php" method="get">
        <div class="container6">
            ...
            <div class="row100">
                ...
                <h3 class="titleText"><a href="orders-view.php" class="btn"> Refresh </a>| <a href="orders-view.php" class="btn"> Back </a></h3>
                <div class="col">
                    <div class="inputBox">
