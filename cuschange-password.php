...
if (isset($_GET['user_id'])) {
    ...
    if ($result_set) {
        if (mysqli_num_rows($result_set) == 1) {
            ...
            // user not found
            header('Location: customer-view.php?err=user_not_found');
        }
    } else {
        // query unsuccessful
...
//modify data in  the table
    if(empty($errors)){
        ...
        if($result3){
            header('Location:customer-view.php?user_modified=true');
...
<section class="banner2">
    ...
    <header>
        ...
        <ul class="navigation">
            ...
            <li><a href="customer-view.php">Back</a></li>
    ...
    <form action ="cuschange-password.php" method ="post" class="userform">
