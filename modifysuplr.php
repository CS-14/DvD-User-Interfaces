...
//View    
    ...
    //Getting that movie information
      ...
      $query="SELECT * FROM supplier WHERE SupplierId='{$sid}'";
...
//      }
    ...
    // $InventoryId=mysqli_real_escape_string($connection,$invid);
      ...
      $query = "UPDATE supplier SET SupplierId = '{$sid}', FirstName = '{$fname}', LastName = '{$lname}',  Email  = '{$email}', PhoneNo  = '{$tele}' ,Address = '{$Address}'WHERE  SupplierId = '{$sid}' LIMIT 1";
...
<section class="banner2">
        ...
        <header>
            <a href="#" class="logo">Modify Supplier</a>
            ...
            <ul class="navigation">
                ...
                <li><a href="supplierlist.php">Back</a></li>
 ...
 ?>
    ...
    <div class="content">
        <div class="contentBx">
            ...
            <h3 class="textTitle"><a href="supplierlist.php" class="btn"> < Back to Supplier List</a></h3>
        </div>
    </div>
...
<p>     
  <label for="">&nbsp;</label>
  <button type="submit" name="submit" class="save_button" id = "signup_btn" >save</button >
