    ...
    //Getting that movie information
      ...
      $result_set=mysqli_query($connection,$query);
          if($result_set){
            ...
            //query unsuccessful
            header('Location:tvlist.php?err=query failed');
          }
...
//      }
    ...
    if($result)
    {
      // query successful... redirecting to users page
        header('Location: tvlist.php?user_modified=true');
    }
    else
    {
      echo $query;
...
<section class="banner2">
    ...
    <header>
        <a href="#" class="logo">Modify TV Series</a>
 ...
 <div class="content">
  <div class="contentBx">
    ...
    <h3 class="titleText"> TV Series Modification </h3>
    </div>
    </div>


        <form action = "modifytv.php"  method ="post" >  
  ...
  <div class="col">
      ...
      <span class="line"></span>
        ...
        <p>     
          ...
          <a id="link" href="tvlist.php">Back to TV Series List</a></span>
        </p>
        </form>
