...
$result_set = mysqli_query($connection, $query);
	...
	if($result_set){
		...
		$query2 = "INSERT INTO dvd (DVD_Id,Name,Is_Movie,Is_TV_Series,Price,description,CategoryId,AdminId,InventoryId,Is_deleted)  
		 VALUES (
		{$mid}, '{$Name}','0','1',{$mprice},'{$mdesc}',{$catid},'784582637V','1','0')";
		        ...
		        echo '
                  <script>
                                if(!alert("Movie added successfully")) {
                                    window.location.href = "http://localhost/movieweb/tvlist.php"
                                }
                  </script>
