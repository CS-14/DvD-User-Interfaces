...
<div class="toggleMenu" onmouseover="toggleMenu();"></div>
 ...
 <div class="content">
  <div class="contentBx">
    ...
    <h3 class="titleText" class="btn"> Add New Movie <a href="adduser.php" class="btn"> + Add New Movie</a></h3>
    </div>
    </div>

        <form class ="myform" action = "addcategory.php"  method ="post"  > 
	...
	<div class="col">
      <div class="inputBox">
        <input type="text" name="categoryId" class ="inputvalues" required >
...
<div class="col">
	...
	<div class="col">
      <div class="inputBox">
        <input type="text" name="description" class = "inputvalues" required >
...
<div class="col">
      <div class="inputBox">
      <input type="text" name="adminId" class = "inputvalues" required  >
      ...
      <span class="line"></span>
        ...
        <p>     
          ...
          <a id="link" href="categorylist.php" >Back to Category List</a>
...
<div class="container7">
        ...
        <ul class="sci">
         ...
         <li><a href="https://youtu.be/sw37q27OwWk?list=PL3kra323EBqstgTVbG5Fr9AcP6ZAmcx8q"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
